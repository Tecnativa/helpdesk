...
class KsDashboardNinjaBoard(models.Model):
    ...
    def ks_set_date(self, ks_dashboard_id):
        ...
        if ks_date_filter_selection not in ['l_custom', 'l_none']:
            ks_date_data = ks_get_date(ks_date_filter_selection, self._context.get('tz', self.env.user.tz), 'datetime')
    ...
    def ks_import_item(self, dashboard_id, **kwargs):
        ...
        if 'ks_file_format' in ks_dashboard_file_read and ks_dashboard_file_read['ks_file_format'] == 'ks_dashboard_ninja_item_export':
    ...
    def ks_import_dashboard(self, file):
        ...
        if 'ks_file_format' in ks_dashboard_file_read and ks_dashboard_file_read['ks_file_format'] == 'ks_dashboard_ninja_export_file':
